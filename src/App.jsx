        ...
        >
          <div style={{ background: D.card, border: `1px solid ${D.border}`, borderRadius: "8px", padding: "1.5rem", width: "280px" }}>
            ...
            <input
              ...
              style={{ width: "100%", boxSizing: "border-box", border: `1px solid ${pwError ? D.danger : D.border}`, borderRadius: "4px", padding: "0.5rem", marginBottom: "0.5rem", fontSize: "0.9rem", colour: "black", backgroundColor: "transparent" }}
            />
